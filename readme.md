...
1️⃣ Load and analyze student dataset  
2️⃣ Preprocess data (cleaning & feature engineering)  
3️⃣ Train machine learning model  
4️⃣ Evaluate performance metrics  
5️⃣ Display predictions and results  
